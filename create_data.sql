USE bug_hunter;
 ...
 INSERT INTO bugs (user_id, title, traceback)
 ...
 INSERT INTO answers (user_id, bug_id, content)
 ...
 INSERT INTO answer_upvotes (user_id, answer_id)
 VALUES (2, 1),
        (2, 2),
        (3, 2),
        (2, 3),
 ...
 INSERT INTO bug_upvotes (user_id, bug_id)
 VALUES (2, 3),
        (2, 5),
        (3, 5),
        (1, 6),
