...
module.exports = {
  ...
  getById: (req, res) => {
    db_connection.query('SELECT b.bug_id, posted_by, error, traceback, message, bug_created, bug_updated, answer_id, answered_by, answer_content, answer_created, answer_updated FROM bugs AS b LEFT JOIN answers AS a ON b.bug_id = a.bug_id WHERE b.bug_id = ?', [req.params.id],
